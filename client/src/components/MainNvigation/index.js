	...
	fashion: [
		{
			...
			navLabel: 'Men',
			navData: [
				{ to: 'fashion/men/topwear', display: 'Topwear' },
				{ to: 'fashion/men/bottomwear', display: 'Bottomwear' },
				{ to: 'fashion/men/footmwear', display: 'Footwear' },
			],
		},
		{
			src: womenFashion,
			navLabel: 'Women',
			navData: [
				{ to: 'fashion/women/topwear', display: 'Topwear' },
				{ to: 'fashion/women/bottomwear', display: 'Bottomwear' },
				{ to: 'fashion/women/footmwear', display: 'Footwear' },
			],
		},
	],
	electronics: [
