	...
	fashion: [
		{
			...
			navLabel: 'Men',
			navData: [
				{ to: 'clothing/men/topwear', display: 'Topwear' },
				{ to: 'clothing/men/bottomwear', display: 'Bottomwear' },
				{ to: 'clothing/men/footwear', display: 'Footwear' },
			],
		},
		{
			src: womenFashion,
			navLabel: 'Women',
			navData: [
				{ to: 'clothing/women/topwear', display: 'Topwear' },
				{ to: 'clothing/women/bottomwear', display: 'Bottomwear' },
				{ to: 'clothing/women/footwear', display: 'Footwear' },
			],
		},
	],
	electronics: [
